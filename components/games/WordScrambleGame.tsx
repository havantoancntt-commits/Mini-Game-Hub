        ...
        <div className="flex flex-col items-center p-6 sm:p-8 w-full max-w-md mx-auto text-center bg-slate-800/60 backdrop-blur-md rounded-2xl border border-slate-700/50 animate-fade-in-up">
          ...
          <p className="text-slate-400 mb-4">Unscramble the letters to form a word.</p>
           ...
           <div className="flex gap-8 mb-4 text-xl">
            ...
            <div className="w-full min-h-[18rem] bg-slate-900/50 rounded-lg flex flex-col items-center justify-center p-4 border border-slate-700">
                {gameState !== 'playing' ? (
                    ...
                    <>
                        <p className="text-3xl sm:text-4xl font-bold tracking-widest text-cyan-300 mb-8">{scrambledWord}</p>
                        <form onSubmit={handleSubmit} className="w-full max-w-sm">
                            <input 
                                type="text"
                                value={inputValue}
                                onChange={(e) => setInputValue(e.target.value)}
                                className="w-full p-3 text-center bg-slate-700/80 text-white rounded-md text-xl sm:text-2xl uppercase focus:outline-none focus:ring-2 focus:ring-cyan-500"
                                autoFocus
                            />
