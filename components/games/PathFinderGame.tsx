...
const PathFinderGame: React.FC<PathFinderGameProps> = ({ onBack }) => {
  return (
    <div className="flex flex-col items-center p-6 sm:p-8 w-full max-w-2xl mx-auto text-center bg-slate-800/60 backdrop-blur-md rounded-2xl border border-slate-700/50 animate-fade-in-up">
      <h2 className="text-4xl font-bold mb-4">Path Finder</h2>
      <p className="text-slate-400 mb-8">
        Coming Soon! A relaxing yet challenging puzzle where you connect all matching dots without crossing paths.
      </p>
